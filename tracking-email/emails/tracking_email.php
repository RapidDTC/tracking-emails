...
<?php
do_action( 'woocommerce_email_header', $blog_name.' - '.__('Shipment status', 'tracking_email'), $email ); ?>

<h1><?php echo $title; ?></h1>

<p><?php _e('The number of your package is', 'tracking_email') ?> <br /><strong><?php echo $tracking; ?><strong></p>
<hr>
<p><?php _e('Sent with', 'tracking_email') ?> <?php echo $service_name; ?></p>
<p style="margin-top:20px;margin-bottom:20px;">
	<a class="btn btn-block btn-outline-secondary" role="button" href="<?php echo $service_url; ?>"><?php _e('Track your parcel', 'tracking_email') ?></a>
</p>
